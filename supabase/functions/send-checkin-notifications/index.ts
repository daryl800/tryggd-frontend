...
const HOME_PRESENCE_LABELS: Record<string, Record<string, string>> = {
  en:       { home: '🏠 At home', outside: '🚶 Outside', busy: '💼 Busy', relaxing: '☕ Relaxing', chilling: '🛋️ Chilling', gathering: '🥳 Hanging out', on_call: '📞 On a call', eating: '🍽️ Having a meal', exhausted: '😩 Exhausted', sleepy: '😪 Sleepy', daydreaming: '💭 Daydreaming', having_fun: '🎉 Having a blast', playing_sport: '⚽ Playing sport', watching_movie: '🎬 Watching a movie', goodmorning: '🌅 Good morning', goodafternoon: '🌞 Good afternoon', goodnight: '🌙 Good night' },
  da:       { home: '🏠 Hjemme', outside: '🚶 Ude', busy: '💼 Optaget', relaxing: '☕ Slapper af', chilling: '🛋️ Chiller', gathering: '🥳 Hænger ud', on_call: '📞 I samtale', eating: '🍽️ Spiser', exhausted: '😩 Udmattet', sleepy: '😪 Søvnig', daydreaming: '💭 Dagdrømmer', having_fun: '🎉 Har det sjovt', playing_sport: '⚽ Spiller sport', watching_movie: '🎬 Ser film', goodmorning: '🌅 God morgen', goodafternoon: '🌞 God eftermiddag', goodnight: '🌙 God nat' },
  de:       { home: '🏠 Zuhause', outside: '🚶 Unterwegs', busy: '💼 Beschäftigt', relaxing: '☕ Entspanne mich', chilling: '🛋️ Chillen', gathering: '🥳 Beim Abhängen', on_call: '📞 Am Telefonieren', eating: '🍽️ Beim Essen', exhausted: '😩 Erschöpft', sleepy: '😪 Schläfrig', daydreaming: '💭 Tagträume', having_fun: '🎉 Habe viel Spaß', playing_sport: '⚽ Beim Sport', watching_movie: '🎬 Schaue einen Film', goodmorning: '🌅 Guten Morgen', goodafternoon: '🌞 Guten Nachmittag', goodnight: '🌙 Gute Nacht' },
  es:       { home: '🏠 En casa', outside: '🚶 Fuera', busy: '💼 Ocupado', relaxing: '☕ Relajándome', chilling: '🛋️ En modo chill', gathering: '🥳 Socializando', on_call: '📞 En llamada', eating: '🍽️ Comiendo', exhausted: '😩 Agotado', sleepy: '😪 Somnoliento', daydreaming: '💭 Soñando despierto', having_fun: '🎉 Pasándola genial', playing_sport: '⚽ Haciendo deporte', watching_movie: '🎬 Viendo una película', goodmorning: '🌅 Buenos días', goodafternoon: '🌞 Buenas tardes', goodnight: '🌙 Buenas noches' },
  fi:       { home: '🏠 Kotona', outside: '🚶 Ulkona', busy: '💼 Kiireinen', relaxing: '☕ Rentoutumassa', chilling: '🛋️ Chillailen', gathering: '🥳 Seurustelemassa', on_call: '📞 Puhelimessa', eating: '🍽️ Syömässä', exhausted: '😩 Uupunut', sleepy: '😪 Uninen', daydreaming: '💭 Haaveilemassa', having_fun: '🎉 Hauskaa pitäen', playing_sport: '⚽ Urheilemassa', watching_movie: '🎬 Katsomassa elokuvaa', goodmorning: '🌅 Hyvää huomenta', goodafternoon: '🌞 Hyvää iltapäivää', goodnight: '🌙 Hyvää yötä' },
  fr:       { home: '🏠 À la maison', outside: '🚶 Sorti(e)', busy: '💼 Occupé(e)', relaxing: '☕ Je me détends', chilling: '🛋️ Cocooning', gathering: '🥳 En train de socialiser', on_call: '📞 En appel', eating: '🍽️ En train de manger', exhausted: '😩 Épuisé', sleepy: '😪 Somnolent', daydreaming: '💭 Dans la lune', having_fun: "🎉 Je m'amuse bien", playing_sport: '⚽ Je fais du sport', watching_movie: '🎬 Je regarde un film', goodmorning: '🌅 Bonjour', goodafternoon: '🌞 Bon après-midi', goodnight: '🌙 Bonne nuit' },
  it:       { home: '🏠 A casa', outside: '🚶 Fuori', busy: '💼 Occupato', relaxing: '☕ Mi rilasso', chilling: '🛋️ Senza pensieri', gathering: '🥳 A socializzare', on_call: '📞 Al telefono', eating: '🍽️ Sto mangiando', exhausted: '😩 Esausto', sleepy: '😪 Assonnato', daydreaming: '💭 Sognando ad occhi aperti', having_fun: '🎉 Mi sto divertendo', playing_sport: '⚽ Faccio sport', watching_movie: '🎬 Guardo un film', goodmorning: '🌅 Buongiorno', goodafternoon: '🌞 Buon pomeriggio', goodnight: '🌙 Buona notte' },
  ja:       { home: '🏠 在宅', outside: '🚶 外出中', busy: '💼 忙しい', relaxing: '☕ くつろぎ中', chilling: '🛋️ のんびり中', gathering: '🥳 集まっておしゃべり中', on_call: '📞 通話中', eating: '🍽️ 食事中', exhausted: '😩 くたくた', sleepy: '😪 眠い', daydreaming: '💭 ぼーっとしてる', having_fun: '🎉 めちゃ楽しんでる', playing_sport: '⚽ スポーツ中', watching_movie: '🎬 映画を観てる', goodmorning: '🌅 おはよう', goodafternoon: '🌞 こんにちは', goodnight: '🌙 おやすみ' },
  ko:       { home: '🏠 집에 있음', outside: '🚶 외출 중', busy: '💼 바쁨', relaxing: '☕ 휴식 중', chilling: '🛋️ 멍 때리는 중', gathering: '🥳 모여서 수다 중', on_call: '📞 통화 중', eating: '🍽️ 밥 먹는 중', exhausted: '😩 너무 피곤해', sleepy: '😪 졸려', daydreaming: '💭 몽상 중', having_fun: '🎉 신나게 놀고 있어', playing_sport: '⚽ 운동 중', watching_movie: '🎬 영화 보는 중', goodmorning: '🌅 좋은 아침', goodafternoon: '🌞 좋은 오후', goodnight: '🌙 잘 자요' },
  no:       { home: '🏠 Hjemme', outside: '🚶 Ute', busy: '💼 Opptatt', relaxing: '☕ Slapper av', chilling: '🛋️ Chiller', gathering: '🥳 Henger med venner', on_call: '📞 I samtale', eating: '🍽️ Spiser', exhausted: '😩 Utmattet', sleepy: '😪 Søvnig', daydreaming: '💭 Dagdrømmer', having_fun: '🎉 Morer meg masse', playing_sport: '⚽ Spiller sport', watching_movie: '🎬 Ser på film', goodmorning: '🌅 God morgen', goodafternoon: '🌞 God ettermiddag', goodnight: '🌙 God natt' },
  sv:       { home: '🏠 Hemma', outside: '🚶 Ute', busy: '💼 Upptagen', relaxing: '☕ Kopplar av', chilling: '🛋️ Chillar', gathering: '🥳 Umgås', on_call: '📞 I samtal', eating: '🍽️ Äter', exhausted: '😩 Utmattad', sleepy: '😪 Sömnig', daydreaming: '💭 Dagdrömmer', having_fun: '🎉 Har jättekul', playing_sport: '⚽ Spelar sport', watching_movie: '🎬 Ser på film', goodmorning: '🌅 God morgon', goodafternoon: '🌞 God eftermiddag', goodnight: '🌙 God natt' },
  th:       { home: '🏠 อยู่ที่บ้าน', outside: '🚶 ออกไปข้างนอก', busy: '💼 ไม่ว่าง', relaxing: '☕ พักผ่อน', chilling: '🛋️ พักสมอง', gathering: '🥳 กำลังสังสรรค์', on_call: '📞 กำลังโทรศัพท์', eating: '🍽️ กำลังกินข้าว', exhausted: '😩 เหนื่อยมาก', sleepy: '😪 ง่วงนอน', daydreaming: '💭 ฝันกลางวัน', having_fun: '🎉 สนุกมาก', playing_sport: '⚽ กำลังเล่นกีฬา', watching_movie: '🎬 กำลังดูหนัง', goodmorning: '🌅 อรุณสวัสดิ์', goodafternoon: '🌞 สวัสดีตอนบ่าย', goodnight: '🌙 ราตรีสวัสดิ์' },
  'zh-Hans': { home: '🏠 在家', outside: '🚶 外出中', busy: '💼 忙碌中', relaxing: '☕ 放松中', chilling: '🛋️ 悠闲中', gathering: '🥳 聚会聊天中', on_call: '📞 电话中', eating: '🍽️ 在吃饭', exhausted: '😩 好累', sleepy: '😪 困了', daydreaming: '💭 在发白日梦', having_fun: '🎉 玩得很开心', playing_sport: '⚽ 运动中', watching_movie: '🎬 看电影', goodmorning: '🌅 早上好', goodafternoon: '🌞 午安', goodnight: '🌙 晚安' },
  'zh-Hant': { home: '🏠 在家', outside: '🚶 在外', busy: '💼 忙碌中', relaxing: '☕ 放鬆中', chilling: '🛋️ 悠閒中', gathering: '🥳 聚會聊天中', on_call: '📞 電話中', eating: '🍽️ 食緊飯', exhausted: '😩 好攰', sleepy: '😪 眼瞓', daydreaming: '💭 在發白日夢', having_fun: '🎉 玩得好開心', playing_sport: '⚽ 運動中', watching_movie: '🎬 看電影', goodmorning: '🌅 早晨', goodafternoon: '🌞 午安', goodnight: '🌙 晚安' },
}
